...
\begin{document}
    ...
    \begin{header}
        \fontsize{25 pt}{25 pt}\selectfont Shivam Gopal Gaikwad
        ...
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{tel:+91-866-824-5526}{+91-866-824-5526}}%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{https://shivamdevfolio.vercel.app/}{Portfolio}}%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
        ...
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{https://play.google.com/store/apps/developer?id=Chartianz}{play.google.com/developer}}%
    \end{header}
    ...
    \section{Professional Summary}
        ...
        \begin{onecolentry}
            Dynamic and detail-oriented \textbf{MERN Stack Developer} and \textbf{Native Android Developer} with 2 years of proven experience in building and maintaining responsive, high-performance \textbf{Web and Mobile Applications.}
            Proficient in leveraging \textbf{MongoDB, Express.js, React.js, and Node.js} to deliver scalable and robust full-stack solutions.
        \end{onecolentry}
